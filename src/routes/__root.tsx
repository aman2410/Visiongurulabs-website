...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "VisionGuru Labs — AI, Software & Digital Transformation" },
      { name: "description", content: "Strategic technology partners for businesses navigating AI, custom software, and digital transformation." },
      { name: "author", content: "VisionGuru Labs LLP" },

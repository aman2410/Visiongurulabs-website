...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://guru-spark-vision.lovable.app/" },
    ...
    links: [{ rel: "canonical", href: "https://guru-spark-vision.lovable.app/" }],
    scripts: [{
      ...
      children: JSON.stringify({
        ...
        url: "https://guru-spark-vision.lovable.app",
      }),
    }],
  }),
  component: Index,
